    ...
    <div>
      <el-form :label-position="labelPosition" label-width="100px" style="width:500px;float:left;">
        ...
        <el-form-item label="选择课件">
          <el-select v-model="wareName" placeholder="请选择" style='width:100%;' clearable>
            <el-option
        ...
        <el-form-item label="随堂测试">
          <el-select v-model="que" placeholder="请选择" style='width:100%;' clearable>
            <el-option
  ...
  methods: {
    ...
    onSubmit () {
      var op = {
        ...
        weekMin: this.starttime,
        weekMax: this.endtime,
        wareId: this.wareName,
        queId: this.que,
